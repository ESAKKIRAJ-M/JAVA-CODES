...
// Design a main() function to input size of the array ‘len' and single
// dimensional array of size 'len', and print the required result by invoking the function print( ).
import java.util.Scanner;
import java.util.Arrays;

public class Day2Part2Q4{
